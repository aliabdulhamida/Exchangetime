      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <ul>
          <li>
            ...
            Services, we may process personal information depending on how you interact with us and
          ...
          <li>
            <b>Do we process any sensitive personal information?</b> Some of the information may be
            considered "special" or "sensitive" in certain jurisdictions, for example your racial or
            ethnic origins, sexual orientation, and religious beliefs. We do not process sensitive
        ...
        <ul>
          <li>
            <b>Consent.</b> We may process your information if you have given us permission (i.e.,
          ...
          <li>
            <b>Vital Interests.</b> We may process your information where we believe it is necessary
        ...
        <p>
          <b>In Short:</b> We are not responsible for the safety of any information that you share
          with third parties that we may link to or who advertise on our Services, but are not
        ...
        <p>
          ...
          an endorsement by us. We cannot guarantee the safety and privacy of data you provide to
          any third-party websites. Any data collected by third parties is not covered by this
        ...
        <p>
          ...
          help us maintain the security of our Services, prevent crashes, fix bugs, save your
        ...
        <p>
          ...
          contact us at info@exchangetime.de .
        </p>

        <h2>10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        <p>
          <b>In Short:</b> Depending on your state of residence in the US or in some regions, such
        ...
        <p>
          ...
          Florida, Indiana, Iowa, Kentucky, Minnesota, Montana, Nebraska, New Hampshire, New Jersey,
          Oregon, Tennessee, Texas, Utah, or Virginia, you may have the right to request access to
        ...
        <table className="min-w-full text-xs border border-gray-300 dark:border-gray-600 mb-4">
          ...
          <tbody>
            ...
            <tr>
              <td className="border px-2 py-1">F. Internet or other similar network activity</td>
              <td className="border px-2 py-1">
        ...
        <p>
          ...
          by emailing us at info@exchangetime.de, or by referring to the contact details at the
        ...
        <p>
          ...
          request, you may appeal our decision by emailing us at info@exchangetime.de. We will
