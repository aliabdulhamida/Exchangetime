...
function CurrencyPairIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        d="M6.1 8.7C6.4 8.3 6.8 8.1 7.3 8.1C7.9 8.1 8.4 8.5 8.4 9.1C8.4 9.7 8 10 7.2 10.2C6.4 10.4 6 10.7 6 11.2C6 11.8 6.6 12.2 7.3 12.2C7.8 12.2 8.2 12 8.5 11.6"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinecap="round"
      />
      ...
      <path
        d="M14.2 8.6C13.9 8.3 13.5 8.1 13 8.1C11.9 8.1 11.2 9.1 11.2 10C11.2 10.9 11.9 11.9 13 11.9C13.5 11.9 13.9 11.7 14.2 11.4"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinecap="round"
      />
      ...
      if (href === '/settings/about') {
          ...
          <div className="max-h-[70vh] overflow-y-auto prose prose-neutral dark:prose-invert px-1">
            ...
            <ul>
              <li>
                ...
                <a href="http://www.exchangetime.de" className="underline">
                  http://www.exchangetime.de
                </a>
            ...
            <ul>
              ...
              <li>
                <b>Do we process any sensitive personal information?</b> Some of the information may
                be considered "special" or "sensitive" in certain jurisdictions, for example your
                racial or ethnic origins, sexual orientation, and religious beliefs. We do not
              ...
              <li>
                <b>How do we keep your information safe?</b> We have adequate organizational and
              ...
              <li>
                <b>How do you exercise your rights?</b> The easiest way to exercise your rights is
            ...
            <ul>
              <li>
                <b>Log and Usage Data.</b> Log and usage data is service-related, diagnostic, usage,
            ...
            <p>
              <b>In Short:</b> We are not responsible for the safety of any information that you
              share with third parties that we may link to or who advertise on our Services, but are
            ...
            <p>
              ...
              privacy of data you provide to any third-party websites. Any data collected by third
            ...
            <p>
              ...
              submitting a request as described below under section "DO UNITED STATES RESIDENTS HAVE
            ...
            <p>
              ...
              age 18, please contact us at info@exchangetime.de .
            </p>
            <h2>10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            <p>
              <b>In Short:</b> Depending on your state of residence in the US or in some regions,
            ...
            <p>
              <b>In Short:</b> If you are a resident of California, Colorado, Connecticut, Delaware,
            ...
            <table className="min-w-full text-xs border border-gray-300 dark:border-gray-600 mb-4">
              ...
              <tbody>
                ...
                <tr>
                  <td className="border px-2 py-1">D. Commercial information</td>
                  <td className="border px-2 py-1">
                ...
                <tr>
                  <td className="border px-2 py-1">E. Biometric information</td>
                  <td className="border px-2 py-1">Fingerprints and voiceprints</td>
                  <td className="border px-2 py-1">NO</td>
                </tr>
                <tr>
                  <td className="border px-2 py-1">
                ...
                <tr>
                  <td className="border px-2 py-1">J. Education Information</td>
                  <td className="border px-2 py-1">Student records and directory information</td>
                  <td className="border px-2 py-1">NO</td>
                </tr>
                <tr>
                  <td className="border px-2 py-1">
                ...
                <tr>
                  <td className="border px-2 py-1">L. Sensitive personal Information</td>
            ...
            <p>
              ...
              Services or for: Category H - 6 months
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                data (as permitted by applicable law, including Minnesota's and Oregon's privacy
                law)
              </li>
              <li>
                Right to review, understand, question, and correct how personal data has been
                profiled (as permitted by applicable law, including Minnesota’s privacy law)
              </li>
              <li>
            ...
            <p>
              ...
              request, by emailing us at info@exchangetime.de, or by referring to the contact
            ...
            <p>
              ...
              your request, you may appeal our decision by emailing us at info@exchangetime.de. We
        ...
        description = (
          <div className="prose prose-neutral dark:prose-invert px-1">
            ...
            <h2>2. USE LICENSE</h2>
            <p>
              Permission is granted to temporarily access Exchange Time for personal, non-commercial
              use only.
            </p>
            <h2>3. DISCLAIMER</h2>
            <p>
              The information provided on Exchange Time is for general informational purposes only.
              All information is provided in good faith, however we make no representation or
              warranty of any kind.
            </p>
            <h2>4. TRADING RISKS</h2>
            <p>
              Trading financial instruments involves high risks including the risk of losing some,
              or all, of your investment amount.
            </p>
            <h2>5. DATA ACCURACY</h2>
            <p>
              While we strive to provide accurate and timely information, there may be inadvertent
              technical or factual inaccuracies and typographical errors.
            </p>
            <h2>6. SERVICE MODIFICATIONS</h2>
            <p>
              Exchange Time reserves the right to modify or discontinue, temporarily or permanently,
              ...
              <div className="mb-1.5">
                {isCollapsed ? (
                  ...
                  <div className="relative overflow-hidden rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#18181b] shadow-sm flex flex-col w-full">
                    ...
                    >
                      <Home
                        className={`h-5 w-5 transition-all duration-300 ${activeView === 'dashboard' ? 'scale-105' : ''}`}
                      />
                    </Link>
                    ...
                    >
                      <BookOpen
                        className={`h-5 w-5 transition-all duration-300 ${activeView === 'blog' ? 'scale-105' : ''}`}
                      />
                    </Link>
                  ...
                  <div className="relative overflow-hidden rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#18181b] shadow-sm flex max-w-[220px]">
                    ...
                    >
                      <Home
                        className={`h-4 w-4 mr-1.5 flex-shrink-0 transition-all duration-300 ${activeView === 'dashboard' ? 'scale-105' : ''}`}
                      />
                    ...
                    >
                      <BookOpen
                        className={`h-4 w-4 mr-1.5 flex-shrink-0 transition-all duration-300 ${activeView === 'blog' ? 'scale-105' : ''}`}
                      />
              ...
              {!isCollapsed ? (
                <>
                  ...
                  >
                    ...
                    <svg
                      className={`w-4 h-4 ml-2 transition-transform ${helpLegalOpen ? 'rotate-90' : '-rotate-90'}`}
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                      viewBox="0 0 24 24"
