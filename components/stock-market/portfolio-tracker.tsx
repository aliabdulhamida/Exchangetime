'use client';
import { RefreshCw, Trash, TrendingUp, TrendingDown } from 'lucide-react';
...
export default function PortfolioTracker() {
  ...
  }, [trackedStocks, stockData, fetchAndCacheStock]);
      ...
      <div className="mb-6">
        ...
        >
          ...
          <Button
            type="submit"
            disabled={loading}
            className="h-10 px-4 flex items-center whitespace-nowrap w-full sm:w-auto mt-2"
          >
            Buy
          </Button>
        </form>
            ...
            >
              {purchases.map((p, i) => {
                ...
                if (price !== null && buyPrice !== null && buyPrice !== 0) {
                  ...
                  returnPct = (
                    <span
                      className={pct > 0 ? 'text-green-600' : pct < 0 ? 'text-red-600' : undefined}
                    >
                      {pctStr}
                    </span>
                  );
                    ...
                    <Tooltip
                      content={({
                        ...
                        return (
                          ...
                          >
                            <div className="mb-0.5" style={{ color: chartColor, fontSize: '11px' }}>
                              {label}
                            </div>
                            <div>
                              <span style={{ color: chartColor, fontSize: '11px' }}>Value:</span> $
