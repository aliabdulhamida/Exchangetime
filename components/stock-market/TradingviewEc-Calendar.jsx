              ...
              >
                <div className="sm:grid sm:grid-cols-[1fr_13rem] sm:items-start sm:gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-foreground sm:text-[15px] sm:leading-6">
                      {event.title}
                    </p>
                  </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 sm:mt-0 sm:w-[13rem]">
                    <div
                      className={`col-span-2 inline-flex w-fit items-center rounded border px-2 py-0.5 text-[11px] font-medium ${impactClass(event.impact)}`}
                    >
                      {event.impact}
                    </div>
