...
export function BlogCard({ post }: BlogCardProps) {
  ...
  if (post.categories.includes("Markets")) {
    ...
    webFallbackImage = "https://images.unsplash.com/photo-1535320903710-d993d3d77d29?auto=format&fit=crop&w=800&h=450";
  } else if (post.categories.includes("Crypto")) {
    webFallbackImage = "https://images.unsplash.com/photo-1516245834210-c4c142787335?auto=format&fit=crop&w=800&h=450";
  } else if (post.categories.includes("Education")) {
    webFallbackImage = "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?auto=format&fit=crop&w=800&h=450";
  } else if (post.categories.includes("Psychology")) {
    webFallbackImage = "https://images.unsplash.com/photo-1507413245164-6160d8298b31?auto=format&fit=crop&w=800&h=450";
  } else if (post.categories.includes("ESG")) {
    webFallbackImage = "https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?auto=format&fit=crop&w=800&h=450";
  } else if (post.categories.includes("Analysis")) {
    webFallbackImage = "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&h=450";
  } else if (post.categories.includes("Strategy")) {
    webFallbackImage = "https://images.unsplash.com/photo-1553729459-efe14ef6055d?auto=format&fit=crop&w=800&h=450";
